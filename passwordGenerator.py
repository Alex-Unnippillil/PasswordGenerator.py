...
class PasswordGeneratorApp:
    ...
    def create_widgets(self):
        ...
        self.label_length.grid(row=1, column=0, sticky="w")
        self.password_length = tk.Entry(self.root, textvariable=self.password_length_value)
        self.password_length.grid(row=1, column=1, sticky="ew")
        ...
        self.charset_frame = ttk.LabelFrame(self.root, text="Character Set")
        self.charset_frame.grid(row=2, column=0, columnspan=2, pady=5, sticky="ew")

        self.check_lowercase = ttk.Checkbutton(self.charset_frame, text="Lowercase", variable=self.use_lowercase, style="Custom.TCheckbutton")
        self.check_lowercase.grid(row=0, column=0, sticky="w")
        self.check_uppercase = ttk.Checkbutton(self.charset_frame, text="Uppercase", variable=self.use_uppercase, style="Custom.TCheckbutton")
        self.check_uppercase.grid(row=0, column=1, sticky="w")
        self.check_digits = ttk.Checkbutton(self.charset_frame, text="Digits", variable=self.use_digits, style="Custom.TCheckbutton")
        self.check_digits.grid(row=1, column=0, sticky="w")
        self.check_special_chars = ttk.Checkbutton(self.charset_frame, text="Special Characters", variable=self.use_special_chars, style="Custom.TCheckbutton")
        self.check_special_chars.grid(row=1, column=1, sticky="w")
        ...
        self.strength_label.grid(row=4, column=0, columnspan=2)
        ...
        self.password_listbox.grid(row=9, column=0, columnspan=2, padx=10, pady=5, sticky="nsew")
